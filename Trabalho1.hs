...
mcpAND (x1, x2) = neuronioMCP [1, 1] [fromIntegral x1, fromIntegral x2] 1.5

mcpOR :: (Int, Int) -> Int
-- weights = [1, 1], theta = 0.5
mcpOR (x1, x2) = neuronioMCP [1, 1] [fromIntegral x1, fromIntegral x2] 0.5

mcpNAND :: (Int, Int) -> Int
-- weights = [-1, -1], theta = -1.5
mcpNAND (x1, x2) = neuronioMCP [-1, -1] [fromIntegral x1, fromIntegral x2] (-1.5)

mcpNOR :: (Int, Int) -> Int
-- weights = [-1, -1], theta = -0.5
mcpNOR (x1, x2) = neuronioMCP [-1, -1] [fromIntegral x1, fromIntegral x2] (-0.5)
